...
public class MyLanguageParser extends Parser {
	...
	public final UseEffectContext useEffect() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((((_la - 29)) & ~0x3f) == 0 && ((1L << (_la - 29)) & 174550155649L) != 0)) {
				{
				{
				setState(118);
				useEffectContent();
	...
	public final UseEffectContentContext useEffectContent() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((((_la - 36)) & ~0x3f) == 0 && ((1L << (_la - 36)) & 1363673091L) != 0)) {
				{
				{
				setState(141);
				_la = _input.LA(1);
				if ( !(((((_la - 36)) & ~0x3f) == 0 && ((1L << (_la - 36)) & 1363673091L) != 0)) ) {
				_errHandler.recoverInline(this);
				}
				else {
					if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final SrcContext src() throws RecognitionException {
		...
		try {
			...
			case LBrack:
				...
				setState(498);
				_la = _input.LA(1);
				if ( !(_la==Path || _la==ARRAY_STRING_VALUES) ) {
				_errHandler.recoverInline(this);
				}
				else {
					if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
